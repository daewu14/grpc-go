...
const file_orders_proto_rawDesc = "" +
	...
	"\tGetOrders\x12\x11.GetOrdersRequest\x1a\x11.GetOrderResponse\"\x00B\"Z github.com/daewu14/common/ordersb\x06proto3"
...
var file_orders_proto_depIdxs = []int32{
	...
	0, // 1: GetOrderResponse.orders:type_name -> Order
	1, // 2: OrderService.CreateOrder:input_type -> CreateOrderRequest
	3, // 3: OrderService.GetOrders:input_type -> GetOrdersRequest
